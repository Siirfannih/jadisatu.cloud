...
export function buildReplyInstructions(lastMessage: string, leadScore: number): string {
  ...
  return [
    ...
    '',
    '== DIAGNOSA DULU (lakukan DALAM HATI sebelum menulis — JANGAN tulis hasil diagnosa/label ini ke balasan) ==',
    '',
    ...
    '- JAWAB: jawab PRIMARY intent. Kalau data spesifik (harga/angka/stok/jadwal/ketersediaan/alamat/lokasi) TIDAK ada persis di Knowledge/Brand Memory → JANGAN mengarang angka/alamat. Bilang jujur "aku cekkan dulu biar nggak salah info ya" lalu lanjut kualifikasi. Hanya sebut harga/alamat kalau memang tertulis di Knowledge/Brand Memory.',
    ...
    '',
    '== FORMAT ==',
    '- OUTPUT = HANYA teks pesan yang dikirim ke customer. JANGAN tulis heading/label apa pun (ACK, JAWAB, ARAH, Diagnosa, Bahasa, Intent, Tone) atau proses berpikirmu.',
    ...
    '',
    '== CONTOH (label sebelum tiap contoh HANYA penanda buat kamu — JANGAN ikut ditulis. BAHASA dicerminkan, sapaan tidak menelan intent bisnis, langkah berikutnya relevan) ==',
    '',
    'EN, sapaan saja:',
